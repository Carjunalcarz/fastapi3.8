...
from app.db.models.schema.user import UserOutput , UserInCreate ,UserInLogin , UserWithToken 
...
class UserService:
    ...
    def signup(self , user_details : UserInCreate)-> UserOutput:
        ...
        hashed_password = HashHelper.get_password_hashed(plain_password=user_details.password)
